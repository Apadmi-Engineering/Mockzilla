        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <img src={logo}  alt="Mockzilla Logo" className="h-5"/>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a target="_top" href="https://github.com/Apadmi-Engineering/Mockzilla/issues" className="hover:text-foreground transition-colors">Support</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 text-sm text-muted-foreground mt-4 sm:mt-0">
            <div className="flex space-x-2">
              <Button variant="ghost" size="sm" onClick={() => window.location.href = "https://github.com/Apadmi-Engineering/Mockzilla/"}>
