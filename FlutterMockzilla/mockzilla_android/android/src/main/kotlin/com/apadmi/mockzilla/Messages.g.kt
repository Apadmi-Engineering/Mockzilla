...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): BridgeMockzillaConfig {
      ...
      val localHostOnly = pigeonVar_list[2] as Boolean
      val logLevel = pigeonVar_list[3] as BridgeLogLevel
      val isNetworkDiscoveryEnabled = pigeonVar_list[4] as Boolean
      return BridgeMockzillaConfig(port, endpoints, localHostOnly, logLevel, isNetworkDiscoveryEnabled)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
