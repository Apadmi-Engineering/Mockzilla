...
class BridgeEndpointConfig {
  ...
  static BridgeEndpointConfig decode(Object result) {
    ...
    return BridgeEndpointConfig(
      ...
      webApiDefaultResponse: result[5] as BridgeMockzillaHttpResponse?,
      webApiErrorResponse: result[6] as BridgeMockzillaHttpResponse?,
    );
  }
}
...
class MockzillaHostApi {
  ...
  Future<BridgeMockzillaRuntimeParams> startServer(BridgeMockzillaConfig config) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.mockzilla_android.MockzillaHostApi.startServer$__pigeon_messageChannelSuffix';
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as BridgeMockzillaRuntimeParams?)!;
    }
  }

  Future<void> stopServer() async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.mockzilla_android.MockzillaHostApi.stopServer$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
...
abstract class MockzillaFlutterApi {
  ...
  static void setUp(MockzillaFlutterApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.mockzilla_android.MockzillaFlutterApi.generateAuthHeader$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        __pigeon_channel.setMessageHandler(null);
      } else {
