...
abstract class FetchPackagesRequest with _$FetchPackagesRequest {
  const factory FetchPackagesRequest({required String query}) =
...
abstract class FetchPackagesResponse with _$FetchPackagesResponse {
  const factory FetchPackagesResponse({required List<Package> packages}) =
...
abstract class Package with _$Package {
  const factory Package({required String name, required String description}) =
      _Package;
